<script lang="ts">
    ...
    import thumb from "$lib/assets/thumb_copium.png";
            ...
            <Tabs.Root value="about" class="space-y-6 mx-4">
                ...
                >
                    ...
                    <div class="flex flex-col gap-8">
                        <p>
                            Tech internship management platform ensuring
                            efficient workflows with a never-stale job board,
                            real-time insights, and powerful application
