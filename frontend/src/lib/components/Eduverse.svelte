            ...
            table: [
                {
                    ...
                    results:
                        "Responsive and accessible design. User-friendly UI/UX.",
                },
                {
                    tech: "Django & PostgreSQL",
                    purpose: "Search Engine, REST API & Storage",
                    results:
                        "Search endpoint using Django ORM, PostgreSQL to query profiles and posts with filters.",
                },
                {
                    tech: "Postman",
                    purpose: "API Testing",
                    results:
                        "50+ API endpoint tested, achieved 98% test coverage.",
                },
            ],
        },
    ];
                    ...
                    <div class="flex gap-8 justify-between mt-4 border border-dashed border-stone-300 dark:border-stone-800 p-4 rounded-lg">
                        <ul class="space-y-3 list-disc marker:text-yellow-900/80 marker:dark:text-yellow-700/80 pl-5">
                            <li class="text-md">
                                ...
                                reducing data response time by 40%.
                            </li>
                            <li class="text-md">
                                Created search endpoint using Django ORM,
                                PostgreSQL to query profiles and posts with
                                filters, optimized request to endpoint
                                efficiency by 50%, reducing search query
                                response time by 20%.
                            </li>
                            <li class="text-md">
                                Redesigned frontend using React and Tailwind,
                                resulting in 57% reduction in page load time,
                                35% reduction in API fetch time.
                            </li>
                            <li class="text-md">
                                Tested 50+ API endpoint using Postman, achieved
                                98% test coverage by validating responses across
                                500+ test cases.
                            </li>
                        </ul>
                    </div>
