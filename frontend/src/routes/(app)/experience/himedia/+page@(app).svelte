    ...
    const card = [
        {
            ...
            table: [
                ...
                },
                {
                    ...
                    results:
                        "Improved scalability, 25% faster backend response times.",
                },
            ],
        },
    ];
    ...
    <Tabs.Content value="about" class="border-none pr-4 outline-none">
        ...
        <div class="">
            <ul class="space-y-3 list-disc pl-5">
                <li class="text-md">
                    Built 3 web applications adhering to SDLC as a full-time OJT, gained experience in Java, JS, Bootstrap, Oracle DBMS development.
                </li>
                <li class="text-md">
                    Improved scalability, 25% faster backend response times by implementing backend features using Object-Oriented Programming.
                </li>
            </ul>
        </div>
    </Tabs.Content>
